...
//     }
//     const forDefiHash = Buffer.from(unsignedTxJson.signatureRequests[0].message, 'hex').toString(
//         'base64'
//     )
...
//                 count += delegator.rewardOwner.addresses.filter(
//                     (addr: string) => addr.toLowerCase() === pAddressBech32.toLowerCase()
//                 ).length
//             }
//         }
//     }
